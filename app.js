/* 332A Exam Simulator, Application Logic */

const ACCESS_CODE  = "332A9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "332a_exam_state_v1";
const SIM_Q_COUNT  = 120;  // real Red Seal 332A exam length; config.json exam.sim_questions
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"common_occupational_skills": "Common Occupational Skills", "hair_and_scalp_care": "Hair and Scalp Care", "cuts_hair": "Cuts Hair", "styles_hair": "Styles Hair", "chemical_texture_services": "Chemical Texture Services", "alters_hair_colour": "Alters Hair Colour", "specialized_services": "Specialized Services", "salon_operations": "Salon Operations"};  // maps domain key -> human-readable label for display
